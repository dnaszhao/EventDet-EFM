...
try:
    ...
    from torchdata.stateful_dataloader.stateful_dataloader import MapDataPipe
...
def build_streaming_train_dataset(
    ...
    # Use a pickleable top-level callable so Windows multiprocessing can
    # spawn dataloader workers for mixed/stream sampling.
    if dataset_config.ssod:  # semi-supervised learning
        augmentation_datapipe_type = partial(
